...
class Match(BaseModel): listing:ProduceListing; distance_km:float; score:MatchScore; logistics_feasible:bool=True
class Allocation(BaseModel): listing_id:str; farmer_name:str; quantity_kg:float; price_per_kg:float; distance_km:float
